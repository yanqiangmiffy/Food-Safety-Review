...
sub['label'] = labels
sub.to_csv('result/capsule.csv', index=None)
...
train['pred'] = labels
# 分类报告
train.to_excel('result/capsule_train.xlsx', index=None)
